        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Article = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCompatibilities_Make_Model_YearFrom_YearTo",
                table: "ProductCompatibilities",
                columns: new[] { "Make", "Model", "YearFrom", "YearTo" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSubscriptions_UserId_ProductId_Type_IsActive",
                table: "ProductSubscriptions",
                columns: new[] { "UserId", "ProductId", "Type", "IsActive" });
